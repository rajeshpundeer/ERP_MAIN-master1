...
public class pocket_money_webview extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pocket_money_webview);
    ...
    private void geturl() {
        ...
        call.enqueue(new Callback<LiveClass1Response>() {
            ...
            public void onResponse(Call<LiveClass1Response> call, Response<LiveClass1Response> response) {
                mProg.dismiss();
                myURL = response.body().url_pocketmoney+"&stud_id=" + studentid + "&mobile=" + mobileno + "&otp=" + otp;

                if (InternetCheck.isInternetOn(pocket_money_webview.this) == true) {
                    WebViewClients webViewClient = new WebViewClients(pocket_money_webview.this);
