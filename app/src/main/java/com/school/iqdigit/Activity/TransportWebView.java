...
public class TransportWebView extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_transport_webview);
    ...
    private void geturl() {
        ...
        call.enqueue(new Callback<LiveClass1Response>() {
            ...
            public void onResponse(Call<LiveClass1Response> call, Response<LiveClass1Response> response) {
                mProg.dismiss();
                myURL = response.body().url_transport+"&stud_id=" + studentid + "&mobile=" + mobileno + "&otp=" + otp;

                if (InternetCheck.isInternetOn(TransportWebView.this) == true) {
                    WebViewClients webViewClient = new WebViewClients(TransportWebView.this);
