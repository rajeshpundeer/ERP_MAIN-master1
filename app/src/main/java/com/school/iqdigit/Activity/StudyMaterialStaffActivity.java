...
public class StudyMaterialStaffActivity extends AppCompatActivity {
    ...
    private String TAG = "StudyMaterialStaffActivity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_study_material_staff);
        final Staff staff = SharedPrefManager2.getInstance(StudyMaterialStaffActivity.this).getStaff();
        ...
        myURL = BuildConfig.BASE_UR + "iqdigit_2020/study_material/index.php?teacher_id="+teachetid+"&mobile="+mobileno+"&otp="+otp;
        Log.d(TAG , myURL);
...
//        webSettings.setSupportMultipleWindows(true);
        ...
        if(InternetCheck.isInternetOn(StudyMaterialStaffActivity.this)==true) {
        ...
        back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                String webviewurl = webView.getUrl().substring(8);
                String url = myURL.substring(7);
                Log.d(TAG , webviewurl + " webviewurl");
                Log.d(TAG , url +" url");
                if (webviewurl.equals(url)) {
                    finish();
                } else {
                    webView.goBack();
                }
        ...
        public boolean shouldOverrideUrlLoading(WebView view, String url) {
            ...
            if (url.contains("browser=chrome")) {
                if (isAppInstalled) {
                    ...
                    AlertDialog dialog = new AlertDialog.Builder(StudyMaterialStaffActivity.this)
