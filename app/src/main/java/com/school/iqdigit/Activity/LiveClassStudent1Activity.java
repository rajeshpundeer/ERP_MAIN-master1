...
public class LiveClassStudent1Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_live_class_student1);
    ...
    private void geturl() {
        ...
        call.enqueue(new Callback<LiveClass1Response>() {
            ...
            public void onResponse(Call<LiveClass1Response> call, Response<LiveClass1Response> response) {
                mProg.dismiss();
                myURL = response.body().studurl_prefix+"&stud_id=" + studentid + "&mobile=" + mobileno + "&otp=" + otp;
                runLiveclass(myURL);
            }
            @Override
    ...
    public void runLiveclass(String url) {
        ...
        if (isAppInstalled) {
            ...
            AlertDialog dialog = new AlertDialog.Builder(LiveClassStudent1Activity.this)
    ...
    private void showsnackbar() {
        ...
        Snackbar snackbar = Snackbar
                ...
                .setAction(R.string.retry, new View.OnClickListener() {
                    @Override
                    public void onClick(View view) {
                        if (InternetCheck.isInternetOn(LiveClassStudent1Activity.this) == true) {
