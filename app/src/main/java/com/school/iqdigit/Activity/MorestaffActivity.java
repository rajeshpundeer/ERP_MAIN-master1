...
public class MorestaffActivity extends AppCompatActivity {
    ...
    private String TAG = "MorestaffActivity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final Staff staff = SharedPrefManager2.getInstance(MorestaffActivity.this).getStaff();
        mobileno = staff.getPhone_number();
        teachetid = staff.getId();
        imgHome = findViewById(R.id.imgHome);
        sp = getSharedPreferences(USER_PREF, Context.MODE_PRIVATE);
        otp = sp.getString(KEY_OTP, "");
        myURL = BuildConfig.BASE_UR + "reports/staff_more.php?teacher_id=" + teachetid + "&mobile=" + mobileno + "&otp=" + otp;
        Log.d(TAG, myURL);
        ...
        if(InternetCheck.isInternetOn(MorestaffActivity.this)==true) {
        ...
        public boolean shouldOverrideUrlLoading(WebView view, String url) {
            ...
            if (url.contains("browser=chrome")) {
                if (isAppInstalled) {
                    ...
                    AlertDialog dialog = new AlertDialog.Builder(MorestaffActivity.this)
