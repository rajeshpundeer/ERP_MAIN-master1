...
public class CircularsStaffAdapter extends RecyclerView.Adapter<CircularsStaffAdapter.AssSubHolder> {
    private Context mCtx;
    private List<CircularsStaff> circularList;
    DownloadManager downloadManager;

    public CircularsStaffAdapter(Context mCtx, List<CircularsStaff> circularList) {
        this.mCtx = mCtx;
    ...
    public void onBindViewHolder(@NonNull final AssSubHolder assSubHolder, int i) {
        final CircularsStaff circular = circularList.get(i);
