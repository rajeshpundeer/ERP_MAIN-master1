...
public class ExpandableListAdapter extends BaseExpandableListAdapter {
    ...
    public View getChildView(int groupPosition, final int childPosition,
        ...
        StringTokenizer tokens = new StringTokenizer(childText, "_");
        String chaptername = tokens.nextToken();
        String chapterid = tokens.nextToken();
        System.out.println("First_string : "+chaptername);
        System.out.println("File_Ext : "+chapterid);
        if (convertView == null) {
        ...
        txtListChild.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(_context, StudyMaterialTutorialActivity.class);
